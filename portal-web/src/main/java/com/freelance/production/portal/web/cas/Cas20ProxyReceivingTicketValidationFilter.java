package com.freelance.production.portal.web.cas;
...
public class Cas20ProxyReceivingTicketValidationFilter extends AbstractTicketValidationFilter {
    ...
    protected final TicketValidator getTicketValidator(final FilterConfig filterConfig) {
        ...
        final com.freelance.production.portal.web.cas.Cas20ServiceTicketValidator validator;
        ...
        if (CommonUtils.isNotBlank(allowAnyProxy) || CommonUtils.isNotBlank(allowedProxyChains)) {
            ...
            validator = new com.freelance.production.portal.web.cas.Cas20ServiceTicketValidator(casServerUrlPrefix);
        }
